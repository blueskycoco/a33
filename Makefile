...
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_it.o
...
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_cortex.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_gpio.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_pcd.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_pcd_ex.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_pwr.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_pwr_ex.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_rcc.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_rcc_ex.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_uart.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_uart_ex.o
${COMPILER}/net.axf: ${COMPILER}/stm32f3xx_hal_flash.o
